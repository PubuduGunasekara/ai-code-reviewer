...
export default function Repositories() {
  ...
  async function createReview(e) {
    ...
    try {
      ...
      const fetchRes = await reviewsApi.fetchPR(selectedRepo, parseInt(prNumber));
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-8">
          ...
          <form onSubmit={createReview} className="flex gap-3 flex-wrap">
            <select
              value={selectedRepo}
              onChange={e => setSelectedRepo(e.target.value)}
              className="flex-1 min-w-48 bg-gray-800 border border-gray-700 rounded-xl 
            ...
            <input
              ...
              className="w-48 bg-gray-800 border border-gray-700 rounded-xl 
                         px-4 py-2.5 text-white text-sm focus:outline-none 
                         focus:border-blue-500"
              min="1"
              required
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 
                         disabled:text-gray-500 text-white px-6 py-2.5 rounded-xl 
          ...
          {reviewError && (
            <div className="mt-3 text-red-400 text-sm bg-red-500/10 
          ...
          {reviewing && (
            <div className="mt-3 text-blue-400 text-sm font-mono">
              Fetching PR diff → sending to GPT-4o → analysing code...
        ...
        <div className="mb-8">
          ...
          {connectedRepos.length === 0 ? (
            <div className="bg-gray-900 border border-dashed border-gray-700 
